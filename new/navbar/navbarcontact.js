...
var navbar = document.getElementById('navBarContact').innerHTML = `
<nav class="navbar navbar-expand-lg navbar-dark sticky-top" style="background-color: darkcyan;">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        <a class="nav-item nav-link" href="https://omeronuralpaslan.github.io/#">Ana Sayfa <span
            class="sr-only">(current)</span></a>
        <a class="nav-item nav-link" href="https://omeronuralpaslan.github.io/about.html">Hakkımda</a>
        <a class="nav-item nav-link active" href="https://omeronuralpaslan.github.io/contact.html">İletişim</a>
      </div>
    </div>
  </nav>
`