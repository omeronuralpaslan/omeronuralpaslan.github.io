...
var info = document.getElementById('infoContact').innerHTML = `
<div class="row mx-auto style="width: 1200px;"">
    <div class="col-md-8 col-sm-8 offset-sm-2 offset-md-2 pt-3">
      <div class="card">
        <div class="card-header text-center pb-1" style="background-color: darkred; color: white;">
          <h3>Contact</h3>
        </div>
        <div class="card-body text-center">
          <h5 class="card-title">Feel free to contact me</h5>
          <p class="card-text text-center"> If you want to contact me, please don't wait! </p>
